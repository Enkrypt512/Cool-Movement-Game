...
@onready var Frames_Per_Second_Counter: Label = $"Main/FPS Counter"
...
func _process(delta: float) -> void:
	if Frames_Per_Second_Check.button_pressed:
		GameManager.Frames_Per_Second_Counter = true
		Frames_Per_Second_Counter.text = 'FPS:' + str(int(Engine.get_frames_per_second()))
		Frames_Per_Second_Counter.visible = true
	else:
		GameManager.Frames_Per_Second_Counter = false
		Frames_Per_Second_Counter.text = ''
		Frames_Per_Second_Counter.visible = false
...
# Change Max FPS
func On_Max_Frames_Per_Second_Changed(Value: float) -> void:
	GameManager.Max_Frames_Per_Second = int(Value)
